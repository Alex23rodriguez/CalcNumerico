...
\makeatother
    ...
    \begin{document}
    \title{Practica 1}
    \author{Gonzalez Borja, Miguel \\ Illescas Arizti, Rodrigo \\ Meyer Mañon, Juan Carlos\\ Rodriguez Orozco, Alejandro}
    \date{11 / Marzo / 2018}

    \maketitle
    
    \section*{Introducci\'on}
A continuacion los ejercicios de la practica. Todos fueron realizados en Python 3.6 utilizando los paquetes \textit{numpy} y \textit{scipy.linalg}. Tambien se incluye un cuaderno de IPython para cada ejercicio dentro de la carpeta Ejercicios, junto con los scripts \textit{.py}. Cada uno de estos utiliza los siguientes imports:
...
Vemos que en efecto el metodo de la potencia calculo el eigenvector
dominante de la matriz. Esto se debe a que se cumplen las condiciones
del metodo, es decir: 
\begin{enumerate}
\item A tiene un eigenvalor dominante (8.3545) 
\item Nuestro vector inicial $q_0$ puede ser escrito como combinacion lineal
...
¿Por qué converge tan rapido el metodo? Veamos todos los eigenvalores de
